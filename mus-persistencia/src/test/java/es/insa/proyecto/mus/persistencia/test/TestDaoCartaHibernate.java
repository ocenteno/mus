 ...
 */
	...
	/**
	 * Se inserta una carta, se modifica su número y se comprueba que se recupera
	...
	/**
	 * Se inserta una carta, se guarda su id, se elimina de la DB y se comprueba que 
	 * no se recupera el id guardado antes de eliminarla, sino que se recupera null de la DB
	 */
	@Test
	public void testEliminar() {
		...
		// 3º VERIFICAR (ASERCIÓN)
		Assert.assertNotEquals(
			"Debería devolver null ya que la carta se ha borrado", guardado, enDB);
	}
	

	/**
	 * Se insertan tres cartas y se comprueba que el tamaño de lo grabado en DB es 3
	 * de la DB	con su número modificado
	 */
	@Test
	public void testListarTodos() {
		...
		// 2º TEST
		int longitudLista = dch.listarTodos().size(); 
