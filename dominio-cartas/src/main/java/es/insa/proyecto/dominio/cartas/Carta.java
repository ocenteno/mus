...
public class Carta implements Comparable<Carta>{
	...
	/**
	 * Se sobreescribe el método equals para que si se compara con: 
	 * 		otra carta, se compare por número, 
	 * 		un Pito, devuelve que es igual sólo si es un uno,
	 * 		un Gocho, devuelve que es igual sólo si es un doce.  
	 */
	@Override
