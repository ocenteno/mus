	...
	<tr height="25%">
		...
		<td width="34%" align="center">
			<table>
				...
				<tr>
					<td><img id="imagen" alt="" src="imagenes/reversoCarta.jpg" width="50px" height="75px"></td>
					<td><img id="imagen" alt="" src="imagenes/reversoCarta.jpg" width="50px" height="75px"></td>
					<td><img id="imagen" alt="" src="imagenes/reversoCarta.jpg" width="50px" height="75px"></td>
					<td><img id="imagen" alt="" src="imagenes/reversoCarta.jpg" width="50px" height="75px"></td>
				</tr>
	...
	<tr height="50%">
		...
		<td bgcolor="green">
			<table>
				<tr>
					<td width="5%">
						...
						<c:if test="${manoPantalla[3] == 1}">
							<img id="imagen" alt="" src="imagenes/mazoCartas.jpg" width="25px" height="25px">
						</c:if>
					</td>
					<td width="90%"></td>
					<td width="5%">
						<c:if test="${manoPantalla[2] == 1}">
							<img id="imagen" alt="" src="imagenes/mazoCartas.jpg" width="25px" height="25px">
						</c:if>
					</td>
				</tr>
				...
				<tr>
					<td>
						<c:if test="${manoPantalla[0] == 1}">
							<img id="imagen" alt="" src="imagenes/mazoCartas.jpg" width="25px" height="25px">
						</c:if>
					</td>
					<td></td>
					<td>
						<c:if test="${manoPantalla[1] == 1}">
							<img id="imagen" alt="" src="imagenes/mazoCartas.jpg" width="25px" height="25px">
						</c:if>
					</td>
				</tr>
	...
	<tr height="25%">
		...
		<td align="center">
			<table>
				...
				<tr>
					<td><img id="imagen" alt="" src="barajas/${cartasJugador[0]}" width="50px" height="75px"></td>
					<td><img id="imagen" alt="" src="barajas/${cartasJugador[1]}" width="50px" height="75px"></td>
					<td><img id="imagen" alt="" src="barajas/${cartasJugador[2]}" width="50px" height="75px"></td>
					<td><img id="imagen" alt="" src="barajas/${cartasJugador[3]}" width="50px" height="75px"></td>
				</tr>
				
				<form action="./accionDescartar.html">
					<tr>
						<td><input name="descarte0" type="checkbox"></td>
						<td><input name="descarte1" type="checkbox"></td>
						<td><input name="descarte2" type="checkbox"></td>
						<td><input name="descarte3" type="checkbox"></td>
					</tr>
					...
					<tr>	
						<td colspan="4">
							<input id="descartar" type="submit" value="Descartar" />
							<input id="jugadorEnviado" type="hidden" value="${mesaPantalla[0]}" />							
						</td>					
					</tr>
				</form>
